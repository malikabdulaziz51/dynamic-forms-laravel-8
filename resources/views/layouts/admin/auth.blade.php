...
<head>
    ...
    <!-- General CSS Files -->
    <link rel="stylesheet"
        href="/admin/library/bootstrap/dist/css/bootstrap.min.css">
    <link rel="stylesheet"
            ...
            <div class="container mt-5">
                <div class="row">
                    <div
                        ...
                        <!-- Footer -->
                        @include('components.admin.auth-header')

                        <!-- Content -->
                        @yield('main')

                        <!-- Footer -->
                        @include('components.admin.auth-footer')
                    </div>
                </div>
            </div>
        </section>
