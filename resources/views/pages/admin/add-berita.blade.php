...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12">
                    <form action=" {{route('admin.create-berita')}} " method="POST" id="addBeritaForm"
                            ...
                            <div class="card-body">
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input placeholder="Masukkan nama berita" type="text" class="form-control"
                                            name="post_title" id="post_titleID" value="{{old('post_title')}}" required
                                            autofocus>
                                        @error('post_title')
