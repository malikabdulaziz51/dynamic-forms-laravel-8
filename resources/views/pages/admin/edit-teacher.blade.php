    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="#">Guru/Staff</a></div>
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <form action=" {{route('admin.update-teacher', $teacher->id)}} " method="POST" id="editTeacherForm"
                            ...
                            <div class="card-body">
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name="teacher_name" id="teacher_nameID"
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <select class="form-control select2" id="position" name="teacher_position">
                                            <option value="{{ $teacher->position }}" selected>{{ $teacher->position == 1
                                                ? "Guru" : "Staff" }}</option>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        <div class="image-area mt-2"><img id="imageResult"
                                                src="/storage/images/teachers/{{$teacher->photo}}" alt=""
