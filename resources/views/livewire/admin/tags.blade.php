<div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <a href="" class="btn btn-primary" data-toggle="modal" data-target="#tags_modal"><i
    ...
    <div wire:ignore.self class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" id="tags_modal"
        ...
        <div class="modal-dialog" role="document">
            <form class="modal-content" method="POST" @if($updateTagMode) wire:submit.prevent='updateTag()' @else
